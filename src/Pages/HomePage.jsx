  ...
  return (
    ...
    >
      <img
        ...
        onClick={() =>
          navigate(`/detay/${etkinlik.id}`, { state: { etkinlik: etkinlik } })
        }
      />
      <span
...
const EtkinlikKartGrubu = ({ baslik, veriler, link }) => {
  ...
  return (
    <div className="col-12 col-sm-6 col-lg-3" style={{ minHeight: "505px" }}>
  ...
  return (
    <div className="container">
              ...
              {populerEtkinlikler.map((etkinlik, idx) => (
                ...
                >
                  <img
                    ...
                    onClick={() =>
                      navigate(`/detay/${etkinlik.id}`, {
                        state: { etkinlik: etkinlik },
                      })
                    }
                  />
      ...
      <div className="row g-4 my-4 col-12">
        <EtkinlikKartGrubu
          baslik="Konserler"
          veriler={etkinlikler.filter((e) => e.kategori === "konserler")}
          link="/konserler"
        />
        <EtkinlikKartGrubu
          baslik="Tiyatrolar"
          veriler={etkinlikler.filter((e) => e.kategori === "tiyatrolar")}
          link="/tiyatrolar"
        />
        <EtkinlikKartGrubu
          baslik="Spor"
          veriler={etkinlikler.filter((e) => e.kategori === "sporlar")}
          link="/sporlar"
        />
        <EtkinlikKartGrubu
          baslik="Sinemalar"
          veriler={etkinlikler.filter((e) => e.kategori === "sinemalar")}
          link="/sinemalar"
        />
      </div>
    </div>
