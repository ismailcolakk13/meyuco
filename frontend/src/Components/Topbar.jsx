...
{
    return (
        <nav className="navbar navbar-expand-lg navbar-dark shadow-sm" style={{ top: 0, zIndex: 100, background:"linear-gradient(135deg, #1C2D41, #18B38C)",borderBottom: '1px solid black' }}>
            <div className="container">

                {/* ✅ Logo Görseli (Meyuco yazısı yerine) */}
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    ...
                    <div className="d-flex align-items-center">
                        ...
                        <Link to="/profile" className="btn btn-outline-light d-flex align-items-center" style={{fontSize:"14px"}}>
